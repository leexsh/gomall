...
type RegisterReq struct {
	...
	PasswordConfrim string `thrift:"password_confrim,3" frugal:"3,default,string" json:"password_confrim"`
}
...
func (p *RegisterReq) GetPasswordConfrim() (v string) {
	return p.PasswordConfrim
}
...
func (p *RegisterReq) SetPasswordConfrim(val string) {
	p.PasswordConfrim = val
}
...
func (p *RegisterReq) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("password_confrim", thrift.STRING, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.PasswordConfrim); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *RegisterReq) DeepEqual(ano *RegisterReq) bool {
	...
	if !p.Field3DeepEqual(ano.PasswordConfrim) {
		return false
	}
	return true
}
...
func (p *RegisterReq) Field3DeepEqual(src string) bool {
	...
	if strings.Compare(p.PasswordConfrim, src) != 0 {
		return false
	}
	return true
}
