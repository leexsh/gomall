...
func (p *kProductServiceClient) ListProducts(ctx context.Context, req *product.ListProductReq, callOptions ...callopt.Option) (r *product.ListProductResp, err error) {
